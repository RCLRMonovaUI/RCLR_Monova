...
function Library:UpdateColorsUsingRegistry()
    ...
    pcall(function()
        if Library.SyncThemeColorPickers then Library:SyncThemeColorPickers() end
        if Library.ReapplyGlass and Library.GlassEnabled then Library:ReapplyGlass() end
    end)
end
    ...
    pcall(function()
        local function setCP(idx, color)
            ...
            elseif opt.SetValue then
                ...
                opt.Value = color
                if opt.Display then pcall(function() opt:Display() end) end
                if opt.Update then pcall(function() opt:Update() end) end
            end
        end
