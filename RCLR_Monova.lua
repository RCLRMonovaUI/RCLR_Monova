...
do
    ...
    function Funcs:AddButton(...)
        ...
        local function CreateBaseButton(Button)
            -- Linoria classic look: black outer + main-colored inner + inner gradient
...
function Library:CreateWindow(...)
    ...
    -- ============================================================
    -- LINORIA-STYLE RESIZE CORNER (contained inside the rounded corner)
    -- ============================================================
    do
        ...
        ResizeCorner.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                StartResize(Input.Position, Input.UserInputType);
            end;
        end);
    end;
...
-- ============================================================
-- MOBILE UI (Linoria-style flat buttons)
-- ============================================================
if InputService.TouchEnabled then
    ...
    local function CreateMobileButton(name, text, startPos)
        -- Linoria-style: outer black frame + inner main-colored frame
        -- + inner gradient + centered white text, no rounded corners.
        local Outer = Library:Create('Frame', {
            Name             = name .. "Outer",
            BackgroundColor3 = Color3.new(0, 0, 0),
            BorderColor3     = Color3.new(0, 0, 0),
    ...
    local LockOuter,   LockBtn   = CreateMobileButton("Lock",   "Unlock UI", UDim2.new(0, 10, 0, 10 + BTN_H + BTN_GAP))
...
function Library:CreateLiveStudUI(Info)
    ...
    Frame.Position = Side == "Right" and UDim2.new(1, -(W + 10), 0, 80) or UDim2.new(0, 10, 0, 80)
    Frame.ZIndex = 80
    Frame.Parent = Gui

    local stroke = Instance.new("UIStroke")
    stroke.Color = Library.OutlineColor or Color3.fromRGB(50, 50, 50)
    stroke.Thickness = 1
    stroke.Parent = Frame
    ...
    local function axis(y, name)
        ...
        line.Position = UDim2.fromOffset(8, y)
        ...
        a.Position = UDim2.fromOffset(14, y - 1)
        a.Size = UDim2.fromOffset(16, 14)
        a.Font = Enum.Font.Code
        a.TextSize = 12
        a.TextColor3 = Library.FontColor or Color3.fromRGB(255, 255, 255)
        ...
        v.Position = UDim2.new(1, -70, 0, y - 1)
        v.Size = UDim2.fromOffset(62, 14)
        v.Font = Enum.Font.Code
        v.TextSize = 12
        v.TextColor3 = Library.FontColor or Color3.fromRGB(255, 255, 255)
    ...
    local xV, xL = axis(28, "X")
    local yV, yL = axis(48, "Y")
    local zV, zL = axis(68, "Z")

    pcall(function() Library:MakeDraggable(Frame, 24, false) end)
    ...
    local conn = RunService.Heartbeat:Connect(function(dt)
        ...
        xL.BackgroundColor3 = Library.AccentColor or xL.BackgroundColor3
        yL.BackgroundColor3 = Library.AccentColor or yL.BackgroundColor3
        zL.BackgroundColor3 = Library.AccentColor or zL.BackgroundColor3
        xV.TextColor3 = Library.FontColor or xV.TextColor3
        yV.TextColor3 = Library.FontColor or yV.TextColor3
        zV.TextColor3 = Library.FontColor or zV.TextColor3

        local hrp = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
        if hrp then
            local p = hrp.Position
            xV.Text = string.format("%.0f", p.X)
            yV.Text = string.format("%.0f", p.Y)
            zV.Text = string.format("%.0f", p.Z)
        else
    ...
    function API:SetVisible(v) Frame.Visible = not not v; Gui.Enabled = not not v end
