    ...
    do
        ...
        TabArea.InputChanged:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseWheel then
                local step = (input.Position.Z or 0) * 60
                local target = clampCanvas(TabArea.CanvasPosition.X - step)
                TweenService:Create(TabArea, TweenInfo.new(0.28, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
...
for i = 1, 53 do
    Library["_PerfHelper_" .. i] = function(a, b)
