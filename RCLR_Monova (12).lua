...
function Library:SyncThemeColorPickers()
    ...
    pcall(function()
        local map = {
            CP_Accent = Library.AccentColor,
            CP_BG = Library.BackgroundColor,
            CP_Main = Library.MainColor,
            CP_Outline = Library.OutlineColor,
            CP_Font = Library.FontColor,
        }
        for idx, color in pairs(map) do
            local opt = Options and Options[idx]
            if opt and color then
                opt.Value = color
                pcall(function()
