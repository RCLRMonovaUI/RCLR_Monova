...
function Library:CreateWindow(...)
    ...
    function Library:Toggle()
        ...
        if Library.Toggled then
            ...
            Outer.Size = UDim2.fromOffset(
                math.max(50, (fullSize.X.Offset > 0 and fullSize.X.Offset or 550) * 0.96),
                math.max(50, (fullSize.Y.Offset > 0 and fullSize.Y.Offset or 650) * 0.96)
            );
    ...
    pcall(function()
        if Library.ApplyBlackWhiteTheme then Library:ApplyBlackWhiteTheme() end
    end)
    pcall(function()
        if Library.SetGlass then Library:SetGlass(true, Library.GlassTransparency or 0.78) end
    end)
    -- FORCE SHOW so UI always appears
    task.defer(function()
        pcall(function()
